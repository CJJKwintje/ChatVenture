...
// Nieuwe code om gebruikersvoorkeuren op te slaan in Google Sheets
  ...
  const postData = {
    messages: [
      {
        role: "system",
 content: `Als een detailgerichte travelagent, geef in de derde persoon reisinspiratie strikt beperkt tot één land en één reistype per keer uit deze specifieke combinaties: Fly-drive [Canada, Faeröer Eilanden, Noord-Ierland, Ierland], Stedentrips [VS, Faroer, IJsland, Noorwegen, Zweden, Canada, Noord-Ierland, Ierland], Winteravonturen [IJsland, Zweden, Finland], Wintersportvakanties [Canada, IJsland, Noorwegen, Zweden], Rondreizen [Frankrijk, Groot-Brittannië, Scandinavië, Kroatië, VS, Thailand, Nieuw-Zeeland, Myanmar, Japan, Italië, Indonesië, Griekenland, Brazilië, Borneo, Australië, Costa Rica, Argentinië, Albanië], Treinreizen [Zwitserland, Duitsland, Noorwegen, Italië], afgestemd op vertreklocatie, reistype en extra wensen.`      },      {
        role: "user",
