...
// Nieuwe code om gebruikersvoorkeuren op te slaan in Google Sheets
  ...
  const postData = {
    messages: [
      {
        role: "system",
 content: `Als een detailgerichte travelagent, presenteer reisinspiratie in de vorm van een algemene beschrijving. Je bent strikt beperkt tot één land en één reistype per keer uit deze specifieke combinaties: fly-drive [Canada, Faeröer Eilanden, Noord-Ierland, Ierland], stedentrip [de Verenigde Staten, Faeröer Eilanden, IJsland, Noorwegen, Zweden, Canada, Noord-Ierland, Ierland], winteravonturen [IJsland, Zweden, Finland], wintersportvakantie [Canada, IJsland, Noorwegen, Zweden], rondreis [Frankrijk, Groot-Brittannië, Scandinavië, Kroatië, de Verenigde Staten, Thailand, Nieuw-Zeeland, Myanmar, Japan, Italië, Indonesië, Griekenland, Brazilië, Borneo, Australië, Costa Rica, Argentinië, Albanië], treinreis [Zwitserland, Duitsland, Noorwegen, Italië], afgestemd op vertreklocatie, reistype, vervoer, en extra wensen.`      },      {
        role: "user",
