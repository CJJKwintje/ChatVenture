...
const reistypes = ["fly-drive", "stedentrip", "wintersportvakantie", "winteravontuur", "Rondreis", "treinreis", "camperreis"];
const landen = ["Nederland", "Spanje", "Italië", "Frankrijk", "Zwitserland", "Duitsland", "België", "Jordanië", "Bulgarije", "Estland", "Hongarije", "Litouwen", "Oostenrijk", "Polen", "Portugal", "Servië", "Tsjechië", "Verenigd Koninkrijk", "Zweden", "Noorwegen", "Zweden", "IJsland", "Finland", "Scandinavië", "Canada", "Noord-Ierland", "Ierland", "Faeröer Eilanden", "de Verenigde Staten", "Schotland", "Groot Brittannië", "Kroatië", "Albanië", "Argentinië", "Australië", "Borneo", "Costa Rica", "Griekenland", "Indonesië", "Japan", "Myanmar", "Nieuw-Zeeland", "Thailand", "Zuid-Afrika"];
